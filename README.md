...
```
git clone https://github.com/Callaghan-Hattingh/argocd-example1.git
```
...
server:
  ...
  config:
    repositories: |
      - type: git
        url: https://github.com/Callaghan-Hattingh/argocd-example1.git
      - name: argo-helm
        type: helm
  ...
  additionalApplications: 
    - name: argocd
      ...
      source:
        ...
        repoURL: https://github.com/Callaghan-Hattingh/argocd-example1.git
        targetRevision: HEAD
      syncPolicy:
        syncOptions:
